...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = fromBytes(cursor.readBytes(Number.parseInt(size3, 10), 32));
  return [value, 32];
}
...
function verify(options) {
  ...
  return secp256k1.verify(signature, from(payload), toBytes3(publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
function decodeData(...parameters) {
  const [abiFunction, data] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi3(abi, name), data2];
    }
    return parameters;
  })();
...
function decodeResult(...parameters) {
  const [abiFunction, data, options = {}] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi3(abi, name), data2, options2];
    }
    return parameters;
  })();
...
function encodeData(...parameters) {
  const [abiFunction, args = []] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi3(abi, name, { args: args3 }), args3];
    }
...
function encodeResult(...parameters) {
  const [abiFunction, output, options = {}] = (() => {
    if (Array.isArray(parameters[0])) {
      ...
      return [fromAbi3(abi, name), output2, options2];
    }
    return parameters;
  })();
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-IYCKDDOI.js.map
