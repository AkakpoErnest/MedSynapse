...
import {
  ...
  numberToHex,
  toHex as toHex2
} from "./chunk-UZ5MMRAM.js";
import "./chunk-5WDAZUWI.js";
import "./chunk-5IWGWMVD.js";
import "./chunk-RTJUH7VC.js";
import "./chunk-632RNAPF.js";
import {
  HashMD
} from "./chunk-K4INVVJW.js";
import {
  rotl,
  wrapConstructor
...
import "./chunk-UI4OEO7G.js";
import "./chunk-GUT5RODB.js";
import "./chunk-YVTAA5QQ.js";
import "./chunk-NSHT7HAF.js";
import "./chunk-VLK7XSG5.js";
import {
  toHex
} from "./chunk-AZA3XBJU.js";
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-X2RWIJ5B.js");
  const signature_ = (() => {
  ...
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V3(this, "events", new import_events3.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i3, s, n2) => {
      ...
      try {
        ...
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(u3), (o2 = n2?.internal) != null && o2.throwOnFailedPublish)
          throw u3;
      } finally {
...
var Ti2 = class extends P {
  ...
  async rpcSubscribe(e, t, i3) {
    ...
    try {
      ...
      if (i3?.transportType === Q.link_mode)
        return setTimeout(() => {
...
var AppKit = class extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await import("./basic-PPRG7P4V.js");
      await import("./w3m-modal-45PKEFHL.js");
...
*/
//# sourceMappingURL=core-TAUH5HLX.js.map
