import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-AK2PHYNF.js";
import "./chunk-JP6S564I.js";
...
import {
  ...
  injected,
  mock
} from "./chunk-2L6IKU7N.js";
import "./chunk-TTNRIITN.js";
import "./chunk-MEXU26SC.js";
import "./chunk-QY6NTPGS.js";
import {
  withRetry,
  withTimeout
} from "./chunk-GUT5RODB.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-5UCNNIZC.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-ZTRI2Z4V.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-5KWJWHS4.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-VYZ6GHBQ.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-RZTAYBOB.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-EU3GBBC6.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3PYFA5PT.js");
