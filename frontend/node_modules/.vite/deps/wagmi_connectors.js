import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-QQYJA3PL.js";
import "./chunk-RTTHEVS3.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-CG3VF2SL.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-2JQ3BYZV.js");
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-HPDCGYKQ.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-TKXVRDLG.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-Y6SXL7VO.js");
