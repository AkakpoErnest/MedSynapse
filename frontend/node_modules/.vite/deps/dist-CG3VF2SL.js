import {
  ...
  init_preact_module,
  y
} from "./chunk-ZCABW2RB.js";
import {
  createJSONStorage,
  createStore,
  getSignPayload2 as getSignPayload,
  persist
} from "./chunk-RTTHEVS3.js";
import {
...
function pointG2FromBytes(bytes2) {
  ...
  const slc = (b, from10, to) => bytesToNumberBE(b.slice(from10, to));
...
async function sign3(options) {
  ...
  const r2 = toBigInt2(slice4(signature_bytes, 0, 32));
...
@noble/hashes/esm/utils.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-CG3VF2SL.js.map
