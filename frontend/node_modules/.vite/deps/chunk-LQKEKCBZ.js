...
var ICONS = {
  add: async () => (await import("./add-KBH2N3QA.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZU2ITNCK.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WVQKWFNZ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-C7FWZGJV.js")).appStoreSvg,
  apple: async () => (await import("./apple-LG6MQBPO.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SXRQJKMK.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-LIKKVNTH.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-SPZ6JRRX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-EZEOJZ2E.js")).arrowTopSvg,
  bank: async () => (await import("./bank-IR6YEB2N.js")).bankSvg,
  browser: async () => (await import("./browser-XFKJYSOE.js")).browserSvg,
  card: async () => (await import("./card-6UMAP7JO.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-XCJD7XEF.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-K5E7ZT6K.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-GWK6N5RQ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-7JW5U5Q5.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-MWAKNDEH.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-JHFHVJC4.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-QQANTEOU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-FSLLTZIB.js")).clockSvg,
  close: async () => (await import("./close-SZVH7OL6.js")).closeSvg,
  compass: async () => (await import("./compass-QOBUO2Q3.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-JNDZRP63.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-WUM62TIM.js")).copySvg,
  cursor: async () => (await import("./cursor-2PYLL37R.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-MEZE7VIN.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-XO7QK2RK.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-QK7F7GRA.js")).disconnectSvg,
  discord: async () => (await import("./discord-TNUOXFCW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OCATK6KA.js")).etherscanSvg,
  extension: async () => (await import("./extension-6VZLENOE.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-32X5IVM6.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-YJKH7TES.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-DUNL655G.js")).farcasterSvg,
  filters: async () => (await import("./filters-7GDDD2US.js")).filtersSvg,
  github: async () => (await import("./github-FTW4RBW7.js")).githubSvg,
  google: async () => (await import("./google-OMTU7I7O.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-3BN3S4F6.js")).helpCircleSvg,
  image: async () => (await import("./image-KDICA3WW.js")).imageSvg,
  id: async () => (await import("./id-NXZRGA7R.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-FPCTWXFX.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-VCLT667T.js")).lightbulbSvg,
  mail: async () => (await import("./mail-6BKERULT.js")).mailSvg,
  mobile: async () => (await import("./mobile-MJLYVDJJ.js")).mobileSvg,
  more: async () => (await import("./more-3UANQ73O.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-I5PEBRJ7.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-Q2Z5LX7U.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-4Y22EUVZ.js")).offSvg,
  playStore: async () => (await import("./play-store-R4FB3RWI.js")).playStoreSvg,
  plus: async () => (await import("./plus-5S4AY4JZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-GUME226N.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-J27RIJFF.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-6WJODWFH.js")).refreshSvg,
  search: async () => (await import("./search-5VRTUV2I.js")).searchSvg,
  send: async () => (await import("./send-WKOPR64F.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-TOIOH62F.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-MFD55ELP.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-FUA4PBYV.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-PFCAA6WY.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-5UATYH2E.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-BPQIHD6Y.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-QRTR3BBF.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-QRAXGIMW.js")).twitchSvg,
  twitter: async () => (await import("./x-JK6IUBLX.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GJMI6LBU.js")).twitterIconSvg,
  verify: async () => (await import("./verify-ZQWV2AYE.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-V4J63D5Y.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GOAPBM6B.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-D6XK7VYC.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-D6XK7VYC.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-D6XK7VYC.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-BSODYY6N.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-2WDMNUBO.js")).warningCircleSvg,
  x: async () => (await import("./x-JK6IUBLX.js")).xSvg,
  info: async () => (await import("./info-7N6UVUFS.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-I4KASB3E.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-ZDD6VFBE.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LQKEKCBZ.js.map
